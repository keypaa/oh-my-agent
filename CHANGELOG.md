...
- Codex CLI Light edition (`omo-codex`) with one-command install via `bunx oh-my-agent install --platform=codex` or `lazycodex` bin entry. (PR #5354)
...
- Triple-publish to npm: `oh-my-agent`, `oh-my-agent`, and `lazycodex`.
...
[Unreleased]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.14.0...HEAD
[4.14.0]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.13.0...v4.14.0
[4.13.0]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.12.1...v4.13.0
[4.12.1]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.12.0...v4.12.1
[4.12.0]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.11.1...v4.12.0
[4.11.1]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.11.0...v4.11.1
[4.11.0]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.2.3...v4.11.0
[4.2.3]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.2.2...v4.2.3
[4.2.0]: https://github.com/code-yeongyu/oh-my-agent/compare/v4.1.2...v4.2.0
