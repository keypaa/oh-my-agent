...
const SCHEMAS: SchemaEntry[] = [
  {
    ...
    description: "JSON schema for oh-my-agent doctor diagnostic output",
    id: "https://raw.githubusercontent.com/code-yeongyu/oh-my-agent/dev/assets/help/doctor.schema.json",
  },
  {
    name: "status",
    schema: StatusSchema,
    title: "System Status",
    description: "JSON schema for oh-my-agent system status output",
    id: "https://raw.githubusercontent.com/code-yeongyu/oh-my-agent/dev/assets/help/status.schema.json",
  },
  {
    name: "sandbox",
    schema: SandboxSchema,
    title: "Sandbox Environment",
    description: "JSON schema for oh-my-agent sandbox execution environment output",
    id: "https://raw.githubusercontent.com/code-yeongyu/oh-my-agent/dev/assets/help/sandbox.schema.json",
  },
  {
    name: "acp",
    schema: AcpSchema,
    title: "ACP Server Status",
    description: "JSON schema for oh-my-agent Agent Control Protocol server output",
    id: "https://raw.githubusercontent.com/code-yeongyu/oh-my-agent/dev/assets/help/acp.schema.json",
  },
]
