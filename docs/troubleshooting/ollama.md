...
When using Ollama as a provider with oh-my-agent agents, you may encounter:
...
- **oh-my-agent**: Passes through the SDK's behavior (can't fix at this layer)
...
**Tracking**: https://github.com/code-yeongyu/oh-my-agent/issues/1124 (closed - documented workaround)
...
- **oh-my-agent**: https://github.com/code-yeongyu/oh-my-agent/issues/1124 (closed - workaround documented)
