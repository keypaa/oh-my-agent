...
import { _resetForTesting, getSessionAgent, registerAgentName, setMainSession, subagentSessions, updateSessionAgent } from "../features/session-state"
...
describe("createChatMessageHandler - /start-work integration", () => {
  ...
  // /start-work integration tests removed: rely on boulder state which was pruned
})
